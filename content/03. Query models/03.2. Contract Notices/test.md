...
|  CM-003 | planning.budget.budgetBreakdown[*].id |  | required | required | inoperable | inoperable | inoperable |
|  CM-004 | planning.budget.budgetBreakdown[*].amount.amount | has to be equal or less than budget.amount.amount in used FS | required | required | inoperable | inoperable | inoperable |
|  CM-005 | planning.budget.budgetBreakdown[*].amount.currency | The same value has to be delivered for each budgetBreakdown | required | required | required | required | required |
|   | **tender** |  |  |  |  |  |  |
